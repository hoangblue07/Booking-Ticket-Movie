                    ...
                    <div>
                        <div className="flex justify-center text-teal-300 sm:justify-start">
                            <svg xmlns="http://www.w3.org/2000/svg" width="400" height="100" viewBox="0 0 400 100">
                                <path d="M20 80 Q100 10 180 80 Q220 120 260 80 Q300 10 380 80" fill="none" stroke="#0000ff" stroke-width="2" />
                                <text x="50%" y="50%" font-family="cursive" font-size="40" text-anchor="middle" fill="#0000ff">Hoàng Blue</text>
                            </svg>
                        </div>
